...
# Ajustar rutas para trabajar desde la raíz del proyecto
BASE_DIR = "AnaliticaProyect" if os.path.exists("AnaliticaProyect") else "."
...
def load_models():
    ...
    with open(os.path.join(models_dir, "modelo_rna.pkl"), "rb") as f:
        modelo_rna = pickle.load(f)
    with open(os.path.join(models_dir, "escalador_rna.pkl"), "rb") as f:
        scaler_rna = pickle.load(f)
    with open(os.path.join(models_dir, "modelo_logistica.pkl"), "rb") as f:
        modelo_logistica = pickle.load(f)
    with open(os.path.join(models_dir, "escalador.pkl"), "rb") as f:
...
def load_ranges():
    ...
    try:
        data_path = os.path.join(BASE_DIR, "uploads", "DEMALE-HSJM_2025_data.xlsx")
        ...
        try:
            ...
            if columnas_faltantes:
                ...
                if st.button("🔮 Procesar Predicciones", type="primary", use_container_width=True):
                    ...
                    salida = os.path.join(BASE_DIR, "uploads", "resultados_prediccion.xlsx")
